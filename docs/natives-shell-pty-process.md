...
This document covers execution/process/terminal primitives in `@san/natives`: `shell`, `pty`, `ps`, and `keys`, using the architecture terms from `docs/natives-architecture.md`.
