...
1. `native` (San) — priority `100`
2. plugin packages — priority `90`
...
Search roots come from `.san` directories:

- project: `<cwd>/.san/commands/*.md`
- user: `~/.san/agent/commands/*.md`
