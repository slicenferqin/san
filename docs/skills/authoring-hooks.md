...
description: Use when creating a new San hook. Covers HookAPI, event catalog, blocking/overriding tool calls, and context modification.
---
...
export default function apiKeyRedactor(pi: HookAPI): void {
