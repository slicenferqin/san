 ...
 * link/envelope half of `@san/coding-agent/src/collab/protocol.ts`;
...
import type { ParsedCollabLink } from "@san/wire";
import { DEFAULT_RELAY_URL, ENVELOPE_HEADER_LENGTH, ROOM_ID_BYTES, ROOM_KEY_BYTES, WRITE_TOKEN_BYTES } from "@san/wire";

export { COLLAB_PROTO } from "@san/wire";
