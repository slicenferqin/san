...
import { getProjectDir, prompt } from "@san/utils";
import {
...
export async function loadSkills(options: LoadSkillsOptions = {}): Promise<LoadSkillsResult> {
	...
	// third-party toggles count here: the San-native providers (`agents`,
	...
	function isSourceEnabled(source: SourceMeta): boolean {
		...
		// Managed skills (auto-learn) are San-native and discovered unconditionally
