...
const hubSchema = type({
	...
	"persist?": type("boolean").describe("start: survive the last San client exiting; default false"),
	"detached?": type("boolean").describe(
		"start: survive every San client and broker exit; implies persist and disables PTY input",
	),
