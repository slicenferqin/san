...
import { type AstReplaceChange, type AstReplaceFileChange, astEdit } from "@san/natives";
import type { Component } from "@san/tui";
import { replaceTabs, Text } from "@san/tui";
import { $envpos, prompt, untilAborted } from "@san/utils";
