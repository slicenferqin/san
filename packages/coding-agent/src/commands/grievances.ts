...
export default class Grievances extends Command {
	...
	static args = {
		...
		// arg keeps the historical `san grievances` invocation working unchanged
	...
	static examples = [
		"san grievances",
		"san grievances list --tool find",
		"san grievances clean --id 209",
		"san grievances clean --tool find",
		"san grievances clean --all",
		"san grievances push",
	];
