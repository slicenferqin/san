...
const EXPRESSION_TYPES: Readonly<Record<Expression["type"], true>> = {
	...
	DecimalLiteral: true,
	ModuleExpression: true,
	TopicReference: true,
	PipelineTopicExpression: true,
	PipelineBareFunction: true,
	PipelinePrimaryTopicReference: true,
...
function isExpression(node: { type: string }): node is Expression {
	return EXPRESSION_TYPES[node.type as Expression["type"]] === true;
}
