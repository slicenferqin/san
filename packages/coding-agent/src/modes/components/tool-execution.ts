...
import type { SnapshotStore } from "@san/hashline";
import {
	Box,
	type Component,
	Container,
...
import { getProjectDir, logger, sanitizeText } from "@san/utils";
	...
	#updateSpinnerAnimation(): void {
		...
		if (needsSpinner && !this.#spinnerInterval) {
			...
			this.#spinnerInterval = setInterval(() => {
				...
				// whole tree (issue #4377). Fall back for lightweight/legacy UI
				// adapters that only implement the root repaint contract.
