...
/**
 * Premium welcome screen with block-based San logo and two-column layout.
 */
...
function introLogoFrame(progress: number): string[] {
	...
	return gradientLogo(SAN_LOGO, phase, { strength: shineStrength, pos: shinePos });
}

/** Resting gradient frame, cached for re-renders outside of the intro. */
const REST_FRAME = gradientLogo(SAN_LOGO, 0);
