...
import type { AssistantMessage, ImageContent, Message, Usage, UsageReport } from "@san/ai";
import type { Component, Container, EditorTheme, Loader, Spacer, Text, TUI } from "@san/tui";
...
export interface InteractiveModeContext {
	...
	/** Refresh the read-only coordination activity projection after a command changes it. */
