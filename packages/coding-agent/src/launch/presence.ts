...
import { isEisdir, isEnoent, postmortem } from "@san/utils";
import { daemonRuntimeDir } from "./paths";

const CLIENTS_DIR = "clients";

/** Handle keeping one San process registered in a project daemon scope. */
...
/** Register this San process so project daemons survive while it remains alive. */
...
/** Return whether a registered San process in this runtime directory is still alive. */
