...
import type * as MnemopiNs from "@san/mnemopi";
import type { Mnemopi, RecallResult } from "@san/mnemopi";
import type * as MnemopiCoreNs from "@san/mnemopi/core";
import type { LocalModelInitializer } from "@san/mnemopi/core";
...
/**
 * Lazily load `@san/mnemopi` (memoized) and route fastembed loads
