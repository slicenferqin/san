...
import { $which, getRemoteHostDir, getSshControlDir, isEnoent, logger, postmortem, ptree } from "@san/utils";
...
export interface SSHHostInfo {
	...
	shell: SSHHostShell;
	/**
	 * Shell name San verified can execute the POSIX transfer snippets
