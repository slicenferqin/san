...
const DISPLAY_NAME = "San";
const DESCRIPTION = "Native San configuration from ~/.san and .san/";
const PRIORITY = 100;
...
registerProvider<Skill>(skillCapability.id, {
	...
	description: "Auto-generated managed skills from ~/.san/agent/managed-skills",
