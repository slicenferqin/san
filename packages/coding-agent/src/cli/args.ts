 ...
 */
import { APP_NAME, CONFIG_DIR_NAME, logger } from "@san/utils";
 ...
 * setter table itself can stay free of `@san/utils` runtime imports
...
${chalk.bold("Useful Commands:")}
  san agents unpack           - Export bundled subagents to ~/.san/agent/agents (default)
  san agents unpack --project - Export bundled subagents to ./.san/agents`;
}
