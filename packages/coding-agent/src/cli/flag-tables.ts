 ...
 * `@san/utils` (or anything that transitively does). That package's
 ...
 * runtime imports from `@san/utils`, which is the whole reason it can
 ...
 */
export const PROFILE_BOOTSTRAP_BOUNDARY_ARG = "--san-profile-boundary";
