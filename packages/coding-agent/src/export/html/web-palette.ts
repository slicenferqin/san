/**
 * Web/export palette — the San brand identity shared by the collab-web live
 * client on the legacy `my.omp.sh` relay and every HTML export/share viewer.
 *
 ...
 * colors for every San user. The public web artifacts want the collab-web
