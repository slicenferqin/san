/**
 * Internal URL router for internal protocols (`agent://`, `artifact://`, `history://`, `issue://`, `local://`, `mcp://`, `memory://`, `san://`, `pr://`, `rule://`, `skill://`, `ssh://`, and `vault://`).
 *
...
export class InternalUrlRouter {
	...
	constructor() {
		this.register(new OmpProtocolHandler("san"));
		this.register(new OmpProtocolHandler("omp"));
