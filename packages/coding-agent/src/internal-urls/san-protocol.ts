/**
 * Protocol handler for San documentation URLs.
 *
 * Serves statically embedded documentation files bundled at build time.
 *
 * URL forms:
 * - san:// - Lists all available documentation files
 * - san://<file>.md - Reads a specific documentation file
 */
...
/**
 * Handler for san:// URLs, with omp:// kept as a legacy alias.
 *
 * Resolves documentation file names to their content, or lists available docs.
 */
export class SanProtocolHandler implements ProtocolHandler {
	readonly scheme: "san" | "omp";
	readonly immutable = true;

	constructor(scheme: "san" | "omp" = "san") {
		this.scheme = scheme;
	}
