...
export function sanXAIUserAgent(): string {
	return "san/xai";
}
 ...
 *      overrides for image-generation traffic. The gate routes the borrow case
 *      to step 2 while preserving every dedicated xai-oauth path.
