import type { ServiceTier, ServiceTierByFamily } from "@san/ai";
 ...
 * `flex`/`priority`. Used by the subagent/advisor single-value settings, which
 * apply one tier to whatever family the target model belongs to.
 */
