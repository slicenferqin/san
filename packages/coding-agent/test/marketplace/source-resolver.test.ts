...
import type { MarketplacePluginEntry } from "@san/coding-agent/extensibility/plugins/marketplace";
import { resolvePluginSource } from "@san/coding-agent/extensibility/plugins/marketplace";
