...
import { compileRuleCondition } from "@san/coding-agent/capability/rule";
import { buildRuleFromMarkdown, createSourceMeta } from "@san/coding-agent/discovery/helpers";
