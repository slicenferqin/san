...
import * as skillsModule from "@san/coding-agent/extensibility/skills";
...
import { SKILL_PROMPT_MESSAGE_TYPE } from "@san/coding-agent/session/messages";
...
function createSessionResult(session: AgentSession): CreateAgentSessionResult {
	return {
		session,
		extensionsResult:
			{} as unknown as import("@san/coding-agent/extensibility/extensions/types").LoadExtensionsResult,
		setToolUIContext: () => {},
