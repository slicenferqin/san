...
import { AgentBusyError, type AgentTelemetryConfig, type Tracer } from "@san/agent";
import { type AssistantMessage, Effort } from "@san/ai";
import { Settings } from "@san/coding-agent/config/settings";
import type { ExtensionActions, LoadExtensionsResult } from "@san/coding-agent/extensibility/extensions/types";
...
import type { AuthStorage } from "@san/coding-agent/session/auth-storage";
import {
	finalizeSubprocessOutput,
	runSubprocess,
	SUBAGENT_WARNING_MISSING_YIELD,
} from "@san/coding-agent/task/executor";
...
describe("runSubprocess yield reminders", () => {
	...
	const baseOptions = {
		...
		modelRegistry: {
			refresh: async () => {},
		} as unknown as import("@san/coding-agent/config/model-registry").ModelRegistry,
		enableLsp: false,
	};
