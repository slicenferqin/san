...
import { getPrompt, listPrompts, serverSupportsPrompts } from "@san/coding-agent/mcp/client";
import type { MCPGetPromptResult, MCPPrompt, MCPPromptsListResult } from "@san/coding-agent/mcp/types";
