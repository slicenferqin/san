...
import { calculateTokensPerSecond } from "@san/coding-agent/modes/components/status-line/token-rate";
import type { SegmentContext } from "@san/coding-agent/modes/components/status-line/types";
