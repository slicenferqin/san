...
import { theme as activeTheme, initTheme } from "@san/coding-agent/modes/theme/theme";
import { evalToolRenderer } from "@san/coding-agent/tools/eval-render";
import { previewWindowRows } from "@san/coding-agent/tools/render-utils";
import { type Component, TUI } from "@san/tui";
