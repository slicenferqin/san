...
import { createAutoresearchExtension } from "@san/coding-agent/autoresearch";
import {
...
} from "@san/coding-agent/autoresearch/state";
import { AutoresearchStorage, closeAllAutoresearchStorages } from "@san/coding-agent/autoresearch/storage";
import type { ExperimentResult } from "@san/coding-agent/autoresearch/types";
import type {
	ExtensionAPI,
