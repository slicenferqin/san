...
import { acquireLease, leasePathForSession } from "@san/coding-agent/modes/rpc-v2/crash-recovery";
import type { ApprovalRequest } from "@san/coding-agent/modes/rpc-v2/dto/approval";
import type { InputResourceRef } from "@san/coding-agent/modes/rpc-v2/dto/resources";
import { newApprovalId, newResourceId, newRunId } from "@san/coding-agent/modes/rpc-v2/protocol/ids";
import { RpcV2SessionManager } from "@san/coding-agent/modes/rpc-v2/session-manager";
import { RpcV2StateStore, rpcV2StatePaths } from "@san/coding-agent/modes/rpc-v2/state-store";
