...
import type { SessionId, UploadId } from "@san/coding-agent/modes/rpc-v2/protocol/ids";
import { ResourceUploadManager } from "@san/coding-agent/modes/rpc-v2/resource-upload";
