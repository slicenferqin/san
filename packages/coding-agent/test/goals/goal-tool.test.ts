...
import { completionBudgetReport, GoalRuntime } from "@san/coding-agent/goals/runtime";
import type { Goal, GoalModeState, GoalTokenUsage } from "@san/coding-agent/goals/state";
import { GoalTool } from "@san/coding-agent/goals/tools/goal-tool";
