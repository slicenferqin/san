...
import { runGuidedGoalTurn } from "@san/coding-agent/goals/guided-setup";
...
import { AgentSession as RealAgentSession } from "@san/coding-agent/session/agent-session";
