...
import type { Api, AssistantMessage, Context, Model, SimpleStreamOptions, TextContent, ThinkingContent } from "@san/ai";
...
import { withGeminiThinkingLoopGuard } from "@san/ai/utils/thinking-loop";
