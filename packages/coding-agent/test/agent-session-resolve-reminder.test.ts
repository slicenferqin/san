...
import { Agent, isSoftToolRequirement } from "@san/agent";
...
import { dispatchResolutionDevice, queueResolveHandler } from "@san/coding-agent/tools/resolve";
import { buildNamedToolChoice } from "@san/coding-agent/utils/tool-choice";
