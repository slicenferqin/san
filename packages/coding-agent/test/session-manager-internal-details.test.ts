...
import { type SkillPromptDetails, stripInternalDetailsFields } from "@san/coding-agent/session/messages";
import type { CustomMessageEntry } from "@san/coding-agent/session/session-entries";
