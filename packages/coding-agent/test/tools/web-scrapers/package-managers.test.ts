...
import { handleAur } from "@san/coding-agent/web/scrapers/aur";
import { handleBrew } from "@san/coding-agent/web/scrapers/brew";
import { handleMaven } from "@san/coding-agent/web/scrapers/maven";
import { handleNuGet } from "@san/coding-agent/web/scrapers/nuget";
import { handlePackagist } from "@san/coding-agent/web/scrapers/packagist";
import { handleRubyGems } from "@san/coding-agent/web/scrapers/rubygems";
