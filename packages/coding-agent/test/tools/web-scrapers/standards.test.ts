...
import { handleCheatSh } from "@san/coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@san/coding-agent/web/scrapers/rfc";
import { handleTldr } from "@san/coding-agent/web/scrapers/tldr";
