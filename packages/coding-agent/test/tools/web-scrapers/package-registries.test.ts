...
import { handleCratesIo } from "@san/coding-agent/web/scrapers/crates-io";
import { handleGoPkg } from "@san/coding-agent/web/scrapers/go-pkg";
import { handleHex } from "@san/coding-agent/web/scrapers/hex";
import { handleNpm } from "@san/coding-agent/web/scrapers/npm";
import { handlePubDev } from "@san/coding-agent/web/scrapers/pub-dev";
import { handlePyPI } from "@san/coding-agent/web/scrapers/pypi";
