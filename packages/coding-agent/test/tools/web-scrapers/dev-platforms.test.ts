...
import { handleDevTo } from "@san/coding-agent/web/scrapers/devto";
import { handleGitLab } from "@san/coding-agent/web/scrapers/gitlab";
import { handleHackerNews } from "@san/coding-agent/web/scrapers/hackernews";
import { handleLobsters } from "@san/coding-agent/web/scrapers/lobsters";
