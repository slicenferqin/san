...
import { handleChocolatey } from "@san/coding-agent/web/scrapers/chocolatey";
import { handleDockerHub } from "@san/coding-agent/web/scrapers/dockerhub";
import { handleHackage } from "@san/coding-agent/web/scrapers/hackage";
import { handleMetaCPAN } from "@san/coding-agent/web/scrapers/metacpan";
import { handleRepology } from "@san/coding-agent/web/scrapers/repology";
import { handleTerraform } from "@san/coding-agent/web/scrapers/terraform";
