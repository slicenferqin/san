...
import { handleArxiv } from "@san/coding-agent/web/scrapers/arxiv";
import { handleIacr } from "@san/coding-agent/web/scrapers/iacr";
import { handlePubMed } from "@san/coding-agent/web/scrapers/pubmed";
import { handleSemanticScholar } from "@san/coding-agent/web/scrapers/semantic-scholar";
import type { RenderResult } from "@san/coding-agent/web/scrapers/types";
