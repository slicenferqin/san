...
import { handleBiorxiv } from "@san/coding-agent/web/scrapers/biorxiv";
import { handleOpenLibrary } from "@san/coding-agent/web/scrapers/openlibrary";
import { handleWikidata } from "@san/coding-agent/web/scrapers/wikidata";
