...
import { handleHuggingFace } from "@san/coding-agent/web/scrapers/huggingface";
import { handleSpotify } from "@san/coding-agent/web/scrapers/spotify";
import { handleVimeo } from "@san/coding-agent/web/scrapers/vimeo";
