...
import { handleArtifactHub } from "@san/coding-agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@san/coding-agent/web/scrapers/coingecko";
import { handleDiscogs } from "@san/coding-agent/web/scrapers/discogs";
