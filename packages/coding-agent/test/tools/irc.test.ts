...
import type { SettingPath } from "@san/coding-agent/config/settings-schema";
...
import { type CoordinationDetails, HubTool, isIrcEnabled } from "@san/coding-agent/tools/hub";
