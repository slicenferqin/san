...
import type { AssistantThinkingRenderer } from "@san/coding-agent/extensibility/extensions";
import { AssistantMessageComponent } from "@san/coding-agent/modes/components/assistant-message";
import { clearMermaidCache } from "@san/coding-agent/modes/theme/mermaid-cache";
import { initTheme } from "@san/coding-agent/modes/theme/theme";
import { ImageProtocol, setTerminalImageProtocol, TERMINAL, Text } from "@san/tui";
