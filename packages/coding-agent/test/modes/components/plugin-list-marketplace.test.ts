...
import { PluginManager } from "@san/coding-agent/extensibility/plugins";
import { type InstalledPluginSummary, MarketplaceManager } from "@san/coding-agent/extensibility/plugins/marketplace";
...
} from "@san/coding-agent/modes/components/plugin-settings";
