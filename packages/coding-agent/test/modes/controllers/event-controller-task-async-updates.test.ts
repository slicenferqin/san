...
import type { ToolExecutionComponent } from "@san/coding-agent/modes/components/tool-execution";
...
import type { TaskToolDetails } from "@san/coding-agent/task/types";
import type { BashToolDetails } from "@san/coding-agent/tools/bash";
