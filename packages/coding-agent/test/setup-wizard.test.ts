...
import { runOnboardingSetup } from "@san/coding-agent/commands/setup";
import { Settings } from "@san/coding-agent/config/settings";
import { SETTINGS_SCHEMA } from "@san/coding-agent/config/settings-schema";
import {
	ALL_SCENES,
	...
	type SetupSceneHost,
	selectSetupScenes,
} from "@san/coding-agent/modes/setup-wizard";
import { WebSearchTab } from "@san/coding-agent/modes/setup-wizard/scenes/web-search";
import { SetupWizardComponent } from "@san/coding-agent/modes/setup-wizard/wizard-overlay";
...
import { SEARCH_PROVIDER_OPTIONS, SEARCH_PROVIDER_PREFERENCES } from "@san/coding-agent/web/search/types";
