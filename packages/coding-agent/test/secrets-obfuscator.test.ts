...
import type { AssistantMessage, Context, Message } from "@san/ai";
import {
	...
	SecretObfuscator,
} from "@san/coding-agent/secrets/obfuscator";
import { compileSecretRegex } from "@san/coding-agent/secrets/regex";
