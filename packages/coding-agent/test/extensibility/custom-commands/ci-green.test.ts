...
import { GreenCommand } from "@san/coding-agent/extensibility/custom-commands/bundled/ci-green";
...
import type * as TypeBox from "@san/coding-agent/extensibility/typebox";
