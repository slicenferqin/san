...
import { hindsightBackend, reloadMentalModelsForSession } from "@san/coding-agent/hindsight/backend";
...
import type { AgentSessionEventListener } from "@san/coding-agent/session/agent-session";
