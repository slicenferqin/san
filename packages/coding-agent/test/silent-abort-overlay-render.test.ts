...
import type { ObservableSession } from "@san/coding-agent/modes/session-observer-registry";
...
function makeSubagentRegistry(sessions: ObservableSession[]) {
	...
	} as unknown as import("@san/coding-agent/modes/session-observer-registry").SessionObserverRegistry;
}
