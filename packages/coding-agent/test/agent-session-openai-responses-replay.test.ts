...
import { createOpenAIResponsesHistoryPayload } from "@san/ai/utils";
...
import type { SessionEntry, SessionMessageEntry } from "@san/coding-agent/session/session-entries";
