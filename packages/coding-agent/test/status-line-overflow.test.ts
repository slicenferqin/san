...
import type { StatusLineSegmentId } from "@san/coding-agent/config/settings-schema";
import { StatusLineComponent } from "@san/coding-agent/modes/components/status-line";
import type { SegmentContext } from "@san/coding-agent/modes/components/status-line/segments";
import { renderSegment } from "@san/coding-agent/modes/components/status-line/segments";
import { initTheme, theme } from "@san/coding-agent/modes/theme/theme";
import { getSessionAccentAnsi, getSessionAccentHex } from "@san/coding-agent/utils/session-color";
import { visibleWidth } from "@san/tui";
import { getProjectDir, setProjectDir } from "@san/utils";
