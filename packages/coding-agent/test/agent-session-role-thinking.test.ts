...
import * as autoThinkingClassifier from "@san/coding-agent/auto-thinking/classifier";
...
import { AUTO_THINKING, clampAutoThinkingEffort, resolveProvisionalAutoLevel } from "@san/coding-agent/thinking";
