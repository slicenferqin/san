...
import { renderSearchResult, type SearchRenderDetails } from "@san/coding-agent/web/search/render";
import type { SearchResponse } from "@san/coding-agent/web/search/types";
