 ...
 * - ~/.san/agent/extensions/ (legacy: ~/.pi/agent/extensions/)
 * - <cwd>/.san/extensions/ (legacy: <cwd>/.pi/extensions/)
...
//   1. Place extension files in ~/.san/agent/extensions/ or .san/extensions/
