...
import { buildRequest } from "@san/ai/providers/google-gemini-cli";
import { convertTools } from "@san/ai/providers/google-shared";
import type { Context, Model, TJsonSchema, Tool } from "@san/ai/types";
import {
	enforceStrictSchema,
