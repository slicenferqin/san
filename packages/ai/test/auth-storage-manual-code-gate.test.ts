...
import * as gitlabDuoWorkflowOAuth from "@san/ai/registry/oauth/gitlab-duo-workflow";
import type { OAuthLoginCallbacks, OAuthProviderInterface } from "@san/ai/registry/oauth/types";
