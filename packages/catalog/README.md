...
Model catalog for [San](https://github.com/slicenferqin/san): bundled model database, provider discovery, model identity, classification, and equivalence.
...
Import from subpaths (`@san/catalog/<module>`) or the root barrel.
