...
import { getOAuthProviders } from "@san/ai/registry/oauth";
import { getEnvApiKey } from "@san/ai/stream";
import { Effort } from "@san/catalog/effort";
import { resolveProviderModels } from "@san/catalog/model-manager";
import { getBundledModels } from "@san/catalog/models";
import { DEFAULT_MODEL_PER_PROVIDER, PROVIDER_DESCRIPTORS } from "@san/catalog/provider-models/descriptors";
import { sakanaModelManagerOptions } from "@san/catalog/provider-models/openai-compat";
import type { FetchImpl, ModelSpec, ResolvedOpenAIResponsesCompat } from "@san/catalog/types";
