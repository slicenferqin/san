import { encodeSixel } from "@san/natives";
import { $env, isBunTestRuntime, isTerminalHeadless } from "@san/utils";
...
const CMUX_NOTIFICATION_TITLE = "San";
