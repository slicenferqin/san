...
# terminal transcript.
#
# Prepare a directory (default ~/san-signing) containing:
...
#   SAN_REPO=owner/repo scripts/ci-macos-upload-secrets.sh ~/san-signing
...
DIR="${DIR:-${SAN_SIGNING_DIR:-${OMP_SIGNING_DIR:-$HOME/san-signing}}}"
REPO="${SAN_REPO:-${OMP_REPO:-slicenferqin/san}}"
